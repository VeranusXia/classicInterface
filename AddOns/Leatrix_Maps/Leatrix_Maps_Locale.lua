...
L["Auto change zones"] = "Автоматическая смена зоны"
...
L["Sticky map frame"] = "Закреплённое окно карты"
L["Stonard"] = "Каменор"
...
L["If checked, the default fullscreen map will be used.|n|nNote that enabling this option will lock out some of the other options."] = "Si está marcado, se usará el mapa predeterminado de pantalla completa.|n|nTenga en cuenta que habilitar esta opción bloqueará algunas de las otras opciones."
L["If checked, the map border will be removed."] = "Si está marcado, se eliminará el borde del mapa."
L["If checked, the map frame will remain open until you close it."] = "Si está marcado, el marco del mapa permanecerá abierto hasta que lo cierre."
...
L["If checked, when your character changes zones, the map will automatically change to the new zone."] = "Si está marcado, cuando tu personaje cambia de zona, el mapa cambiará automáticamente a la nueva zona."
...
L["If checked, zone, dungeon and fishing skill levels will be shown."] = "Si está marcado, se mostrarán los niveles de zona, mazmorra y habilidad de pesca."
...
L["Sticky map frame"] = "Marco de mapa pegajoso"
L["Stonard"] = "Rocal"
