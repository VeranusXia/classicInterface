...
echo ## Interface: 70300 > ..\SharedMedia_MyMedia\SharedMedia_MyMedia.toc
...
echo       %%~nF
echo LSM:Register("font", "%%~nF", [[Interface\Addons\SharedMedia_MyMedia\font\%%~nxF]], 255^) >> ..\SharedMedia_MyMedia\MyMedia.lua
)
